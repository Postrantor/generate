...
> C++容器存储一组元素。容器包括向量、列表、映射等。使用Templates，C++容器包含基元（例如int）或自定义类（例如MyClass）的集合。
...
> 选择要使用的C++容器可能很棘手，所以这里有一个简单的流程图来帮助决定哪个容器适合这份工作。
...
> 本流程图基于【Mikael Persson的帖子】(https://stackoverflow.com/a/22671607)。
